...
export default function Register () {
    ...
    const tam = VerificaTamanho()
    const maiúsculo = VerificaMaiusculo()
    const num = VerificaNumero()
                ...
                <div className={styles.container}>
                    <div className="row">
                        <div className="col-md-7">
                            <img src="https://img.freepik.com/free-vector/handling-order-processing-abstract-concept-vector-illustration-order-documentation-processing-system-handling-customer-request-logistics-automated-logistics-operations-abstract-metaphor_335657-1789.jpg?size=626&ext=jpg&ga=GA1.1.995514839.1678974862&semt=ais"
                        ...
                        <div className="col-md-5">
                            ...
                            <h4 className={styles.title}>Registrar</h4>
                            <strong>Email</strong>
                            <input type="email" 
                            ...
                            {tam && num && maiúsculo && pass == confirmPass?
                                ...
                                <button
                                onClick={() => HandleSignIn()}
                                className={`${styles.disabled} ${styles.btn_register}`}
                                disabled
                                >
                                Registrar
                                </button>
                            ...
                            <p className={styles.or}>Ou Registre-se com</p>
                            <button
